...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const cachedOfficials = await helpers.cacheAllOfficialVoyageCounts(await helpers.getChannel(interaction.guild, interaction.client.settings.get(interaction.guild.id, "voyageLogbookChannel")));
